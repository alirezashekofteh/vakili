...
<body class="main-body">
 ...
 <input class="form-control dir-ltr" placeholder="تلفن همراه خود را وارد نمایید" name="mobile" type="text">
                                                </div>
                                                <div class="form-group">
                                                    <label>رمز عبور</label> <input class="form-control dir-ltr"
                                                        placeholder="رمز عبور را وارد کنید" name="password" type="password">
                                                </div>
                                                <div class="form-group">
