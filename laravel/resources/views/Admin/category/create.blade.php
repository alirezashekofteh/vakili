        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    ...
                    <span class="text-muted mt-1 tx-13 mr-2 mb-0"><a href="/admin/category">دسته بندی</a></span>
                    ...
                    @endif
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">عنوان دسته بندی :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" value="{{old('name',$category->name)}}" name="name" type="text">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">عنوان دسته بندی در url :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" value="{{old('slug',$category->slug)}}" name="slug" type="text">
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">توضیحات دسته بندی :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <textarea  class="form-control " id="editor1" name="content">{{old('content',$category->content)}}</textarea>
                                </div>
                               
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">زیر مجموعه دسته بندی :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <select class="form-control" name="parent">
                                        <option value="0">شاخه اصلی</option>
                                        @foreach (\App\Models\Category::where('parent',0)->get()
                                        as $item)
                                        <option value="{{$item->id}}" {{$item->id==$category->parent}}>{{ $item->name}}</option>
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <fieldset class="invoice-address form-group">
                                        <div class="input-group col-sm-12" style="height: 35px">
                                            ...
                                            <input type="text" id="file_label" class="form-control image_label dir-ltr" value="{{old('pic',$category->pic)}}" name="pic"
                            ...
                            <a href="/admin/category" class="btn btn-dark pd-x-30 mg-t-5">بازگشت</a>
                        </div>
                    </form>
                    </div>
                </div>
