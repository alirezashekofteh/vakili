        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    ...
                    <span class="text-muted mt-1 tx-13 mr-2 mb-0">/لیست خدمات</span>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 mg-t-20 mg-lg-t-0">
                                <a href="{{route('admin.Service.create')}}" class="btn btn-indigo btn-with-icon btn-block"><i
                                        class='bx bxs-user-plus bx-sm'></i>افزودن سرویس جدید</a>
                            </div>
                            @endcan
                    ...
                    <div class="card-footer">
                        {{ $Service->appends([ 'search' => request('search') ])->links() }}
                    </div>
                </div><!-- bd -->
            </div>
            <!--/div-->
