        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    ...
                    <span class="text-muted mt-1 tx-13 mr-2 mb-0"><a href="/admin/company">شرکت ها</a></span>
                    ...
                    @endif
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">عنوان شرکت  :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" value="{{old('name',$company->name)}}" name="name" type="text">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" value="{{old('link',$company->link)}}" name="link" type="text">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">فعال بودن شرکت :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <select class="form-control" name="active">
                                        @foreach(config('value.truefalse') as $key => $name)
                                        <option value="{{ $key }}" {{ $company->active==$key  ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            {{-- <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">توضیحات شرکت  :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <textarea  class="form-control " id="editor1" name="content">{{old('content',$company->content)}}</textarea>
                                </div>
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <fieldset class="invoice-address form-group">
                                        <div class="input-group col-sm-12" style="height: 35px">
                                            ...
                                            <input type="text" id="file_label" class="form-control image_label dir-ltr" value="{{old('pic',$company->pic)}}" name="pic"
                            ...
                            <a href="/admin/company" class="btn btn-dark pd-x-30 mg-t-5">بازگشت</a>
                        </div>
                    </form>
                    </div>
                </div>
