        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    ...
                    <span class="text-muted mt-1 tx-13 mr-2 mb-0"><a href="/admin/menu">/لیست منو</a></span>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">لیست منو</h4>
                            <i class="mdi mdi-dots-horizontal text-gray"></i>
                        </div>
                        @can('menu-create')
                        <div class="col-lg-2 mg-t-20 mg-lg-t-0">
                            <a href="{{route('admin.menu.create')}}" class="btn btn-indigo btn-with-icon btn-block"><i
                                    class='bx bxs-user-plus bx-sm'></i>افزودن منو</a>
                        </div> 
                        @endcan
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr class="success">
                                      <td>{{ $item->id}}</td>  
                                        ...
                                        <td>
                                            ...
                                            <div class="row">
                                                <a href="{{route('admin.menu.edit',$item->id)}}" data-toggle="tooltip"
                    ...
                    <div class="card-footer">
                        {{ $menu->appends([ 'search' => request('search') ])->links() }}
                    </div>
                </div><!-- bd -->
            </div>
            <!--/div-->
