                    ...
                    @endif
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">عنوان مطلب :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" value="{{old('name',$post->name)}}" name="name" type="text">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control dir-ltr" placeholder="" value="{{old('slug',$post->slug)}}" name="slug" type="text">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">متن ابتدای مقاله :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">متن کامل مقاله :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <textarea  class="form-control " id="editor1" name="fullcontent">{{old('fullcontent',$post->fullcontent)}}</textarea>
                                </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <select class="form-control" name="category[]" multiple>
                                        ...
                                        as $item)
                                        <option value="{{$item->id}}" {{ in_array($item->id , $post->category->pluck('id')->toArray()) ? 'selected' : '' }}>{{ $item->name}}</option>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <select class="form-control" name="comment">
                                        ...
                                        <option value="{{ $key }}" {{ $post->comment==$key  ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">فعال بودن مطلب :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <select class="form-control" name="active">
                                        @foreach(config('value.truefalse') as $key => $name)
                                        <option value="{{ $key }}" {{ $post->active==$key  ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <fieldset class="invoice-address form-group">
                                        <div class="input-group col-sm-12" style="height: 35px">
                                            ...
                                            <input type="text" id="file_label" class="form-control image_label dir-ltr" value="{{old('pic',$post->pic)}}" name="pic"
                            ...
                            <a href="/admin/post" class="btn btn-dark pd-x-30 mg-t-5">بازگشت</a>
                        </div>
                    </form>
                    </div>
                </div>
