        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    ...
                    <span class="text-muted mt-1 tx-13 mr-2 mb-0">/لیست مطالب</span>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">لیست مطالب</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 mg-t-20 mg-lg-t-0">
                                <a href="{{route('admin.post.create')}}" class="btn btn-indigo btn-with-icon btn-block"><i
                                        class='bx bxs-user-plus bx-sm'></i>افزودن مطلب جدید</a>
                            </div>
                            @endcan
                            ...
                            <table class="table table-striped mg-b-0 text-md-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr class="success">
                                        ...
                                        <td>{{config('value.truefalse.'.$item->comment)}}</td>
