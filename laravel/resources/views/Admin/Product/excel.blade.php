        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    ...
                    <span class="text-muted mt-1 tx-13 mr-2 mb-0">/افزودن محصولات از اکسل</span>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mg-b-20"></p>
                        <form role="form" action="{{route('admin.product.excel')}}" method="POST" enctype="multipart/form-data">
                            @csrf
