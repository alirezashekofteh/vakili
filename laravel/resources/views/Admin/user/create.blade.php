        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    ...
                    <span class="text-muted mt-1 tx-13 mr-2 mb-0">/افزودن - ویرایش کارمند</span>
                </div>
            </div>
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" value="{{old('name',$user->name)}}" name="name" type="text">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control " placeholder="" name="family" value="{{old('family',$user->family)}}" type="text">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 mg-t-5 mg-md-t-0">
                                    <input class="form-control dir-ltr" placeholder="" name="mobile" value="{{old('mobile',$user->mobile)}}"  type="text">
                                </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control dir-ltr" placeholder="" name="email" value="{{old('email',$user->email)}}" type="text">
                                </div>
                            </div>
                          
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                    <label class="form-label mg-b-0">فعال بودن کارمند :</label>
                                </div>
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <select class="form-control" name="status">
                                        @foreach(config('value.truefalse') as $key => $name)
                                        <option value="{{ $key }}" {{ $user->status==$key  ? 'selected' : '' }}>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <a href="/admin/user" class="btn btn-dark pd-x-30 mg-t-5">بازگشت</a>
                        </div>
                    </form>
                    </div>
                </div>
